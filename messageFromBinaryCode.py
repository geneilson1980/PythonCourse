def messageFromBinaryCode(code):
    ...
    for i in range(len(code)):
        ...
        count += 1
        if count == 8:
            expectedOutput = expectedOutput + asciiTable.get(binCode)
            binCode = ''
            count = 0
